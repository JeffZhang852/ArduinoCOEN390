...
//  Serial.print(normGyro.YAxis);
  ...
  Serial.print("\t\tOffseted gravity: ");
  Serial.print(normAccel.ZAxis - 9.8);
...
void count_check(float normZ){
  //Values of raw Z axis and norm Z axis are unknown. Need to find a stable data.
  if(normZ < -0.3){
    start_pos = true;
  }else if(start_pos == true && normZ > 0.3){
    start_pos = false;
    count++;
  }
